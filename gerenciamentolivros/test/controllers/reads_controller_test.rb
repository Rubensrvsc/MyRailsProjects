...
class ReadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create read" do
    assert_difference('Read.count') do
      post reads_url, params: { read: { data_leitura: @read.data_leitura, qtd_lido: @read.qtd_lido } }
    end
  ...
  test "should update read" do
    patch read_url(@read), params: { read: { data_leitura: @read.data_leitura, qtd_lido: @read.qtd_lido } }
